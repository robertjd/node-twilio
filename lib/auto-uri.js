 ...
 *
 * @param {String} base_url: The base URL of the server running this app, such as https://www.example.com:3000
 ...
 */
function AutoUri(base_url, opts) {
    var self = this;

    if(!base_url) {
        throw new Error('AutoUri requires base_url');
    }
    ...
    self.baseUri = base_url + '/' + self.basePath + '/';
