...
RestClient.prototype.getAvailableTollFreeNumbers = function(country, filters, suc, err) {
    ...
    this.apiCall('GET', '/AvailablePhoneNumbers/' + country + '/TollFree',
                 {params: filters}, suc, err);
};
        ...
        this.apiCall('GET', uri, firstRun ? {params: filter} : null, 
            (function(res) {
                ...
                if(res.next_page_uri) {
                    console.log(res.next_page_uri)
                    getRes.call(this,res.next_page_uri);
                } else {
                    suc(col);
                }
            }).bind(this),
...
// StatusCallback, StatusCallbackMethod, SmsUrl, SmsMethod, SmsFallbackUrl, 
// SmsFallbackMethod, VoiceCallerIdLookup
RestClient.prototype.provisionIncomingNumberTollFree = function(num, areaCode, params, suc, err) {
    params = params || {};
    params.PhoneNumber = num;
    this.apiCall('POST', '/IncomingPhoneNumbers/TollFree', {params: params}, suc, err);
};
